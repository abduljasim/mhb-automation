...
//GROUP BROADCAST Selected Units
        ...
        driver.findElement(By.xpath("(//*[@text='UNIT_STATUS_TABLE']/*[@text='ASSIGNED_UNIT_SELECTION_CELL'])[1]")).click();
        ...
        driver.findElement(By.id("Corp Test Users - Selected Unit")).click();
        driver.findElement(By.xpath("(//*[@text='UNIT_STATUS_TABLE']/*[@text='ASSIGNED_UNIT_SELECTION_CELL'])[1]")).click();
        driver.findElement(By.id("BROADCASTS_GROUPS_CELL")).sendKeys("Cancel Selected Unit");
        new WebDriverWait(driver, 50).until(ExpectedConditions.elementToBeClickable(By.id("Cancel"))).click();
        
        // PATIENTS Broadcasts Text
        new WebDriverWait(driver, 50).until(ExpectedConditions.elementToBeClickable(By.id("Corp Test Users - Selected Unit"))).click();
        driver.findElement(By.xpath("(//*[@text='UNIT_STATUS_TABLE']/*[@text='ASSIGNED_UNIT_SELECTION_CELL'])[1]")).click();
        driver.findElement(By.id("broadcast more button")).click();
        new WebDriverWait(driver, 5).until(ExpectedConditions.elementToBeClickable(By.id("TAB_BAR_PATIENTS_ITEM")));
        driver.findElement(By.xpath("//*[@id='Patients']")).click();
...
// QUICK BROADCASTS
        ...
        System.out.println("Broadcast Test Passed!");
